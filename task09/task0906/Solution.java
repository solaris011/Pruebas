package es.codegym.task.pro.task09.task0906;
...
public class Solution {
    ...
    public static int toDecimal(String binaryNumber) {
        ...
        for (int i = 0; i < binaryNumber.length(); i++) {
            int indice = binaryNumber.length() - 1 - i;
            int valor = Character.getNumericValue(binaryNumber.charAt(indice));
            decimalNumber += valor * Math.pow(2, i);
