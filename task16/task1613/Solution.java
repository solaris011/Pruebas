package es.codegym.task.pro.task16.task1613;
...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        if (FRIDAY == dia && dateTime.getHour() >= WEEKEND_START_FRIDAY_CUT_OFF_HOUR)
            return true;

        if (SUNDAY == dia && dateTime.getHour() < WEEKEND_END_SUNDAY_CUT_OFF_HOUR)
            return true;
